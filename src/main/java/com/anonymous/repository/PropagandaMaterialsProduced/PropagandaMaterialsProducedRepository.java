...
import com.anonymous.domain.PropagandaMaterialsProduced.PMPApprovalStatus;
        ...
        JpaSpecificationExecutor
{
    ...
    List<PropagandaMaterialsProduced> findByApplicationDateBetweenAndApprovalStatus(LocalDateTime startTime, LocalDateTime endTime, PMPApprovalStatus executed, PMPApprovalStatus pigeonhole);
}
